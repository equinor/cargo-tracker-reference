...
with grades as (SELECT name as grade
  ...
  WetlistGrade =
	...
	CASE 
        ...
        WHEN grade = 'Alvheim' THEN 'Other North Sea'
        WHEN grade = 'Gina Krog' THEN 'Other North Sea'
        WHEN grade = 'Norne' THEN 'Other North Sea'
        WHEN grade = 'Skarv' THEN 'Other North Sea'
        ELSE grade
    END
from grades;

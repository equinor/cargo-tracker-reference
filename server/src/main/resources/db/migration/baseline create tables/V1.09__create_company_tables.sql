...
create table CT.company_ocd_mapping (
...
ALTER TABLE CT.company_ocd_mapping  WITH CHECK ADD CONSTRAINT FK_ocd_mapping FOREIGN KEY(company_id)
REFERENCES CT.company (id)
GO

ALTER TABLE CT.company_ocd_mapping CHECK CONSTRAINT FK_ocd_mapping
GO
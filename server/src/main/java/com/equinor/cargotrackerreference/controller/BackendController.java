...
public class BackendController {
	...
	TradingArea[] getAllTradingAreas() {
		logger.info("Backend controller retrieving trading areas.");
	...
	Terminal[] getAllTerminals() {
		logger.info("Backend controller retrieving terminals.");

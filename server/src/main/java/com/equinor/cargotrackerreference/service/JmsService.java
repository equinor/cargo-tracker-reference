	...
	public void sendJmsMessage(Object message, String typeid, String operation) {
	       ...
	       try {
	    	   ...
	    	   //Adding properties needed for the qpid library
				...
				logger.debug("Sending message to:\ntopic: {}\ntype: {}\noperation: {}\npayload: {}", messageProducer.getDestination(), jmsTextMessage.getStringProperty(AzureServiceBusConfiguration.TYPEID), operation, jmsTextMessage.getBody(String.class));
